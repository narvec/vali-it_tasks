    ...
    return (
        ...
        <div className="App" >
            ...
            <header className="App-header">
                <Typography xs={12} sm={6} md={4} variant="h3" sx={{ fontFamily: 'monospace' }} >Hello World<span style={{width: '0.5em', display: 'inline-block'}}>
            {isVisible && '_'}
          </span> </Typography>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} sm={6} md={4}>
                        <Item>
                            ...
                            <Typography sx={{textAlign: 'center', color: 'rgb(233,236,224)'}} variant="body1" gutterBottom>
                    ...
                    <Grid item xs={12} sm={6} md={4} >
                        <Item >
                            ...
                            <Typography sx={{textAlign: 'center', color: 'rgb(233,236,224)'}}>
